This is a template theme we use at [SK8Tech](https://sk8.tech). This document lists out the required steps to create a custom WordPress theme for our clients.
